        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4>Edit Booking at {{ $booking->restaurant->name }}</h4>
                </div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('customer.bookings.update', $booking->id) }}" id="bookingForm">
                        @csrf
                        @method('PATCH')
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="date" class="form-control @error('booking_date') is-invalid @enderror"
                                           ...
                                           value="{{ old('booking_date', $booking->booking_datetime->format('Y-m-d')) }}" required>
                                    @error('booking_date')
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="time" class="form-control @error('booking_time') is-invalid @enderror"
                                           ...
                                           value="{{ old('booking_time', $booking->booking_datetime->format('H:i')) }}" required>
                                    @error('booking_time')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="number" class="form-control @error('guests_count') is-invalid @enderror"
                                   ...
                                   value="{{ old('guests_count', $booking->guests_count) }}" min="1" max="20" required>
                            @error('guests_count')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <textarea class="form-control @error('special_requests') is-invalid @enderror"
                                      ...
                                      placeholder="Any special arrangements, dietary requirements, or preferences">{{ old('special_requests', $booking->special_requests) }}</textarea>
                        ...
                        <div class="alert alert-info mb-4">
                            <i class="fas fa-info-circle me-2"></i> Updating your booking will send you a new confirmation email and reminder.
                        </div>

                        <h4 class="mt-4 mb-3">Update Pre-ordered Meals (Optional)</h4>
                        <p class="text-muted mb-3">Modify the meals you'd like to have ready when you arrive.</p>
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="number" class="form-control text-center food-quantity"
                                                                           ...
                                                                           value="{{ old('food_items.' . $item->id . '.quantity',
                                                                                $currentOrders->has($item->id) ? $currentOrders[$item->id]->quantity : 0) }}"
                        ...
                        <div class="form-group mt-4 d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-check me-1"></i> Update Booking
                            </button>
                        </div>
                    </form>
                </div>
