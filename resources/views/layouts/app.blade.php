...
<head>
    ...
    <title>{{ config('app.name', 'Restaurant Booking System') }}</title>
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    {{ config('app.name', 'Restaurant Booking System') }}
                </a>
                    ...
                    <ul class="navbar-nav me-auto">
                        @auth
                            @if(Auth::user()->isCustomer())
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('customer.restaurants.index') }}">Restaurants</a>
                                </li>
